<template>
  <div id="stepCount">
    ...
    <v-layout row justify-space-around>
      <v-card width="45vw">
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="75px" height="75px" viewBox="0 0 500 700" >
        ...
        C188.854,276.228,164.304,282.292,129.029,293.132z" fill="url(#lg)" transform="rotate(45) translate(325, -225)"/>
        </svg>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="75px" height="75px" viewBox="0 0 500 700" >
          <linearGradient id="lg" x1="0" y1="1" x2="0" y2="0">
              <stop offset="0%" stop-opacity="1" stop-color="black"/>
        ...
        c-4.031,28.768,20.294,139.802,49.911,160.711c29.149-7.353,57.771-14.558,86.696-21.078
        C216.162,245.069,213.798,246.352,220.752,225.463z M129.029,293.132c13.547,171.234,175.47,103.231,87.63-26.427
        C188.854,276.228,164.304,282.292,129.029,293.132z" fill="url(#lg)" transform="rotate(
      70) translate(75, -400)"/>
        </svg>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60px" height="75px" viewBox="0 0 500 700" >
          <linearGradient id="lg" x1="0" y1="1" x2="0" y2="0">
              <stop offset="0%" stop-opacity="1" stop-color="black"/>
              <stop offset="40%" stop-opacity="1" stop-color="black"/>
              <stop offset="40%" stop-opacity="1" stop-color="grey"/>
      ...
      110) translate(-75, -575)"/>
        ...
        c-4.031,28.768,20.294,139.802,49.911,160.711c29.149-7.353,57.771-14.558,86.696-21.078
        C216.162,245.069,213.798,246.352,220.752,225.463z M129.029,293.132c13.547,171.234,175.47,103.231,87.63-26.427
        C188.854,276.228,164.304,282.292,129.029,293.132z" fill="url(#lg)" transform="rotate(130) translate(30, -690)"/>
        </svg>
      </v-card>
    </v-layout>
  </div>
