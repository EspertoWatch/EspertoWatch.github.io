<template>
  <div id="stepCount">
    ...
    <v-layout row justify-space-around>
      <v-card width="45vw">
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="515.458px" height="515.458px" viewBox="0 0 515.458 515.458" style="enable-background:new 0 0 515.458 515.458;" xml:space="preserve">
        <linearGradient id="lg" x1="0" y1="1" x2="0" y2="0">
            ...
            <stop offset="40%" stop-opacity="1" stop-color="grey"/>
    ...
    C188.854,276.228,164.304,282.292,129.029,293.132z" fill="url(#lg)"/>
      </svg>
      </v-card>
    </v-layout>
  </div>
